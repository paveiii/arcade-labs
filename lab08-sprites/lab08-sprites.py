...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        create_entities(25, self.enemies, "HM1sprRussianGangster.webp",0.3, 180)
    ...
    def on_update(self, delta_time: float):
        ...
        self.enemies.update()
        points_hit_list = arcade.check_for_collision_with_list(self.jacket.sprite, self.enemies)
        for point in points_hit_list:
            point.remove_from_sprite_lists()
            self.score -= 1
